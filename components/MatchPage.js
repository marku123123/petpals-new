...
const FOUND_DOG_API_URL = "http://10.0.2.2:5000/api/founddog";
const NEW_POSTS_API_URL = "http://10.0.2.2:5000/api/posts/new-posts-count";
const LOST_FOUND_API_URL = "http://10.0.2.2:5000/api/lostfound";
const BASE_API_URL = "http://10.0.2.2:5000";
      ...
      <ScrollView contentContainerStyle={styles.content}>
        {filteredDogs.length > 0 ? (
          ...
          <Text style={styles.noDataText}>
            {searchQuery ? "No matching dogs found." : "No matched dogs reported yet."}
          </Text>
        )}
      </ScrollView>
